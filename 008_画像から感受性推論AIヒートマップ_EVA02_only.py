...
"""
保存済みEVA02-AVG ensembleモデルとcutoffを使い、フォルダー内画像のmedianで推論する単独版。
...
ENSEMBLE_INFO_PATH = "EVA02_model/top5_ensemble_info.pth"
...
def show_result_tk(
    ...
    root = tk.Tk()
    root.title("EVA02-AVG Median Result")
    ...
    tk.Label(
        header,
        text=f"EVA02-AVG Median Prediction: {pred_class}",
        bg=pred_bg,
        fg="white",
        font=("Arial", 22, "bold"),
        anchor="w",
