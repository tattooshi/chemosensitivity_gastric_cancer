# 胃癌の化学療法感受性を ViT-CLS + EVA02-AVG でensemble推論するAI
...
def show_result_tk(
    ...
    root = tk.Tk()
    root.title("ViT + EVA02 Ensemble Result")
    ...
    tk.Label(
        header,
        text=f"Ensemble Prediction: {pred_class}",
        bg=pred_bg,
        fg="white",
        font=("Arial", 22, "bold"),
        anchor="w",
...
def main():
    ...
    show_result_tk(
        ...
        combined_prob=selected["combined_prob"],
        combined_margin=selected["combined_margin"],
