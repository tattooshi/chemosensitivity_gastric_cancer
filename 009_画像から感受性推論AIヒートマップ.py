...
VIT_SPEC = BackendSpec(
    name="ViT-CLS",
    ensemble_info_path=Path(
        "/home/tatsushi/デスクトップ/val-result_weight/ViT616_0602-100/vit_large_patch16_616.augreg_in21k_ft_in1k/Vit_fixed_val_classes_models_0sens_positive/top5_ensemble_info.pth"
    ),
...
EVA02_SPEC = BackendSpec(
    name="EVA02-AVG",
    ensemble_info_path=Path(
        "/home/tatsushi/デスクトップ/val-result_weight/EVA02_0602_0.9/eva02_large_patch14_0448.mim_in22k_ft_in22k/Vit_fixed_val_classes_models_0sens_positive/top5_ensemble_info.pth"
    ),
